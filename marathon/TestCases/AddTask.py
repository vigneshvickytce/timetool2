...
def test():
	...
	if window('TimeTool'):
		...
		assert_p('taskTable', 'Content', '[[Defaul, Default task created by TimeTool, 0, 0.00], [Admin, Administrative time, 0, 0.00], [Lunch, Lunch, 0, 0.00], [New Ta, A new Task, 0, 0.00]]')
